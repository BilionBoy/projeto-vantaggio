...
class GDistritosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create g_distrito" do
    assert_difference("GDistrito.count") do
      post g_distritos_url, params: { g_distrito: { descricao: @g_distrito.descricao, g_municipio_id: @g_distrito.g_municipio_id } }
    end
  ...
  test "should update g_distrito" do
    patch g_distrito_url(@g_distrito), params: { g_distrito: { descricao: @g_distrito.descricao, g_municipio_id: @g_distrito.g_municipio_id } }
